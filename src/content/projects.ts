export interface Project {
  ...
  detail: string;
  stack: string[];
  /** The source. A placeholder for now, so every card carries the icon. */
  repo: string;
  href?: string;
  event?: { name: string; href: string };
}

/** Replace this per project once each repository is public. */
const PLACEHOLDER_REPO = 'https://github.com/Borghese-Gladiator/browser-games__ai/';
